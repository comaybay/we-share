...
<header class="relative z-20 flex px-4 items-center border-b border-pri-base h-16 bg-paper">
			...
			<div class="w-fit ml-auto">
				<ButtonOutline>
					<div class="">
						...
						<a class="align-middle text-lg uppercase" href="/dang-nhap">Đăng nhập</a>
					</div>
				</ButtonOutline>
			</div>
		{/if}
